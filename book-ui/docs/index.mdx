...
#### [Introduction to Physical AI and Embodied Intelligence](/docs/module-1/introduction-to-physical-ai)
...
#### [Digital Twin Simulation](/docs/module-2/digital-twin-simulation)
...
#### [The AI-Robot Brain (NVIDIA Isaac™)](/docs/module-2/ai-robot-brain-isaac)
- Isaac Sim for photorealistic simulation
- Isaac ROS for perception and control
- Visual SLAM and navigation
- Advanced AI integration

### Module 3: Vision-Language-Action (VLA)

#### [Vision-Language-Action Systems](/docs/module-3/vision-language-action)
...
#### [The Autonomous Humanoid Capstone Project](/docs/module-3/autonomous-humanoid-capstone)
- Complete system integration
- End-to-end voice-to-action pipeline
- Navigation and manipulation systems
- Mission planning and validation

### Module 4: AI & Computer Vision

#### [AI for Robotics](/docs/module-4/ai-for-robotics)
- Machine learning for robot perception
- Deep learning and neural networks
- Reinforcement learning for robot control
- Model deployment and optimization

#### [Computer Vision & Navigation](/docs/module-4/computer-vision-navigation)
...
Ready to dive into the exciting world of Physical AI? Start with [Module 1: Introduction to Physical AI and Embodied Intelligence](/docs/module-1/introduction-to-physical-ai) and begin your journey toward building autonomous humanoid robots.
